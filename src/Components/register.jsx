...
const RegistrationForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(`Submitted: ${orderId} ${Productversion} ${DbServer}`);
  };
  const handleOptionYesChangeRaveLegacy = () => {
    setOptionYes(true);
    setOptionNo(false);
  };

  const handleOptionNoChangeRaveLegacy = () => {
    setOptionNo(true);
    setOptionYes(false);
  };
    ...
    <form onSubmit={handleSubmit} className="registration-form">
      ...
      <div style={{width:"100%" }}>
        ...
        <input
            type="checkbox"
            checked={optionYes}
            onChange={handleOptionYesChangeRaveLegacy}
      ...
      <label style={{ display: "inline-block" , width:"20%" , "margin-left": "30%"   }}>Remora</label>    
        <input
          type="checkbox"
          checked={optionNo}
          onChange={handleOptionNoChangeRaveLegacy}
          style={{ display: "inline-block" , width:"10%"  }}
        />
      </div>
      </div>
